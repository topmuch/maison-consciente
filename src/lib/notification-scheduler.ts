...
function mergePrefs(partial: Partial<NotificationPrefs> | NotificationPrefs): NotificationPrefs {
  ...
  return {
    temporal: { ...defaults.temporal, ...(partial as any).temporal },
    weather: { ...defaults.weather, ...(partial as any).weather },
    calendar: { ...defaults.calendar, ...(partial as any).calendar },
    homeSecurity: { ...defaults.homeSecurity, ...(partial as any).homeSecurity },
    inventory: { ...defaults.inventory, ...(partial as any).inventory },
    ambiance: { ...defaults.ambiance, ...(partial as any).ambiance },
    health: { ...defaults.health, ...(partial as any).health },
    hospitality: { ...defaults.hospitality, ...(partial as any).hospitality },
    system: { ...defaults.system, ...(partial as any).system },
    engagement: { ...defaults.engagement, ...(partial as any).engagement },
    quietHours: { ...defaults.quietHours, ...(partial as any).quietHours },
